...
func (_mock *MockPasswordHasher) Compare(hash string, plain string) error {
...
func (_c *MockPasswordHasher_Compare_Call) RunAndReturn(run func(hash string, plain string) error) *MockPasswordHasher_Compare_Call {
	_c.Call.Return(run)
	return _c
}

// Hash provides a mock function for the type MockPasswordHasher
func (_mock *MockPasswordHasher) Hash(plain string) (string, error) {
...
func (_c *MockPasswordHasher_Hash_Call) RunAndReturn(run func(plain string) (string, error)) *MockPasswordHasher_Hash_Call {
	_c.Call.Return(run)
	return _c
}
